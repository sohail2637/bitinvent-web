                    ...
                    <div className='md:flex justify-between items-center gap-5 mb-6 '>
                        {
                            topCardSection.map((data , index) => (
                                <div key={index} className='flex justify-between items-start flex-col bg-[#F8F8F8] md:w-1/3 xl:h-[350px] lg:h-[400px] md:h-[450px] lg:p-9 md:p-6 p-4 rounded-lg md:mb-0 mb-6'>
                                    <div className=''>
